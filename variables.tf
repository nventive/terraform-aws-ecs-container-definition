...
variable "environment_extra" {
  ...
  description = "Extra environment variables to pass to the container. This will be merged with `environment` and will take precedence over already defined variables"
  default     = []
}
...
variable "secrets_extra" {
  ...
  default     = []
  description = "Extra secrets to pass to the container. This will be merged with `secrets` and will take precedence over already secrets"
}
